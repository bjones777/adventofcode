...
let rl = readline.createInterface({
  ...
  function partA() {
    let s = new Simulator(arr);
      let line = '';
      addCommandToSim(s,"NOT B T\n");
      addCommandToSim(s,"NOT C J\n");
      addCommandToSim(s,"AND D J\n");
      addCommandToSim(s,"NOT A T\n");
      addCommandToSim(s,"OR T J\n");
      addCommandToSim(s,"WALK\n");    
  ...
  function partB() {
    let s = new Simulator(arr);
      ...
      addCommandToSim(s,"NOT B T\n");
      addCommandToSim(s,"NOT C J\n");
      addCommandToSim(s,"OR J T\n");
     
      addCommandToSim(s,"NOT H J\n");
      addCommandToSim(s,"NOT J J\n");
      addCommandToSim(s,"AND D J\n");

      addCommandToSim(s,"AND T J\n");

      addCommandToSim(s,"NOT A T\n");
      addCommandToSim(s,"OR T J\n");

      addCommandToSim(s,"RUN\n");    
      s.setOutputCallback((v : bigint) => {
        if(v > 256n) {
          console.log(`Answer: ${v}`);
        }
